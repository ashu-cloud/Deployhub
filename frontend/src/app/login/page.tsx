  ...
  return (
    <div className="min-h-screen bg-background text-on-surface paper-texture flex flex-col justify-between relative overflow-hidden">
      ...
      <main className="flex-grow flex items-center justify-center px-4 py-12 relative z-10">
        <div className="w-full max-w-md flex flex-col items-center translate-y-2">
          {/* Logo Cleanly Positioned Above Card */}
          <div className="mb-8 relative z-20">
            <Link href="/" className="wiggle inline-block transform hover:scale-105 transition-transform">
              <DeployHubLogo className="h-12 md:h-14" />
            </Link>
          </div>
          ...
          <div className="relative w-full">
            ...
            <div className="washi-tape-1 -top-3.5 left-6 bg-tertiary z-20 pointer-events-none"></div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <a
                ...
                className="doodle-btn bg-surface hover:bg-surface-variant text-sketch-white flex items-center justify-center gap-3 py-3 px-6 w-full group relative overflow-hidden paper-shadow cursor-pointer transition-all hover:border-primary"
              >
                {/* GitHub Vector Icon */}
                <svg
                  aria-hidden="true"
                  className="w-5 h-5 text-sketch-white fill-current shrink-0"
                  viewBox="0 0 24 24"
                >
                  <path
                    fillRule="evenodd"
                ...
                <span className="font-mono text-xs font-bold tracking-tight text-on-surface-variant group-hover:text-sketch-white">
